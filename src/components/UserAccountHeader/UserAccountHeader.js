      ...
      <div className="user-account-header">
        ...
        <div className="user-account-header__text-part">
          ...
          <div className="text-part__buttons-group">
            <BlueLink children={<span className="buttons-group__button">Хочу получить <img className="emoji" src={relievedEmoji} /></span>}/>
            <BlueLink children={<span className="buttons-group__button">Хочу подарить <img className="emoji" src={sunglassesEmoji} /></span>}/>
          </div>
